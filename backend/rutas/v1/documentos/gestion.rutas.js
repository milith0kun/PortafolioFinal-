/**
 * Ì≥ã GESTI√ìN DE DOCUMENTOS - CRUD completo de documentos del sistema
 * 
 * Archivo: documentos/gestion.rutas.js
 * Tipo: CRUD Documentos
...
router.get('/', (req, res) => {
    res.json({
        ...
        archivo: 'documentos/gestion.rutas.js',
        descripcion: 'Ì≥ã GESTI√ìN DE DOCUMENTOS - CRUD completo de documentos del sistema',
